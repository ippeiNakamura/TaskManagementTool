...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["Calendar"](calendarEl, {
    plugins: [_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__["default"], _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__["default"], _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_1__["default"]],
    droppable: true,
    events: [// events here
    ],
    editable: true,
    ...
    eventDrop: function eventDrop() {
      //ドラッグ完了時の処理****
      console.log('date'); //draggableEl.style.display = "none";
    },
    drop: function drop(allDay) {
      //ドラッグ完了時の処理****
      if (allDay) {
        draggableEl.style.display = false;
      } //draggableEl.style.display = "none";

    }
  }); //カレンダー外のドラッグ&ドロップ要素の設定

  new _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_1__["Draggable"](draggableEl, {
    eventData: {
      title: gon.task_name,
      duration: gon.time
    }
...
function () {
  ...
  SegHierarchy.prototype.findInsertion = function (newEntry) {
    ...
    for (var level = 0; level < levelCnt; level += 1) {
      var levelCoord = levelCoords[level]; // if the current level is past the placed entry, we have found a good empty space and can stop.
      ...
      entry.span.start < newEntry.span.end // and not entirely past newEntry
        ...
        resLevelCoord < levelCoord + entry.thickness && resLevelCoord + newEntry.thickness > levelCoord) {
      ...
      for (var lateral = insertion.lateralStart; lateral < insertion.lateralEnd; lateral += 1) {
        ...
        if (this.allowReslicing) {
          var placeholderEntry = Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__assign"])({}, leadingEntry), {
            span: Object(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["intersectSpans"])(leadingEntry.span, entry.span)
          });
...
/******/ });
//# sourceMappingURL=event-6bced400f1e47b66d7a6.js.map