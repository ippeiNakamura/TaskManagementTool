...
document.addEventListener('DOMContentLoaded', function () {
  ...
  calendar.render(); // Pen by https://subodh.dev
  ...
  $(document).ready(function () {
    ...
    var isEventOverDiv = function isEventOverDiv(x, y) {
      ...
      offset.bottom = external_events.height() + offset.top; // Compare
  ...
  new _fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_2__["Draggable"](draggableEl, {
    eventData: {
      title: 'my event',
      duration: '02:00'
    }
...
/******/ });
//# sourceMappingURL=event-4f2cfe13f2e26d044853.js.map